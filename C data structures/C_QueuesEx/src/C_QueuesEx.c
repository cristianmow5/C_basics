/*
 ...
 Description :	performs queue manipulations. The program
				provides several options: insert a node in the queue
				(function enqueue ), remove a node from the queue
				(function dequeue ) and terminate the program.
 ============================================================================
 */
